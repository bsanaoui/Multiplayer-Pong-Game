...
-- CreateIndex
CREATE UNIQUE INDEX "Users_room_username_room_name_key" ON "Users_room"("username", "room_name");

-- CreateIndex
CREATE UNIQUE INDEX "Room_name_key" ON "Room"("name");

-- AddForeignKey
ALTER TABLE "Users_room" ADD CONSTRAINT "Users_room_username_fkey" FOREIGN KEY ("username") REFERENCES "User"("username") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Users_room" ADD CONSTRAINT "Users_room_room_name_fkey" FOREIGN KEY ("room_name") REFERENCES "Room"("name") ON DELETE CASCADE ON UPDATE CASCADE;
